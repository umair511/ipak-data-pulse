...
/**
 * Hooks for DowntimeReason routes
 */
export interface DowntimeReasonHooks {
  /**
...
/**
 * Default DowntimeReason hooks (customize as needed)
 */
export const downtimeReasonHooks: DowntimeReasonHooks = {
