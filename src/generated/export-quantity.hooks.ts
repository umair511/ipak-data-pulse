...
/**
 * Hooks for ExportQuantity routes
 */
export interface ExportQuantityHooks {
  /**
...
/**
 * Default ExportQuantity hooks (customize as needed)
 */
export const exportQuantityHooks: ExportQuantityHooks = {
