...
/**
 * Hooks for UserPermission routes
 */
export interface UserPermissionHooks {
  /**
...
/**
 * Default UserPermission hooks (customize as needed)
 */
export const userPermissionHooks: UserPermissionHooks = {
