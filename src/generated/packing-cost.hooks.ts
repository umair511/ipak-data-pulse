...
/**
 * Hooks for PackingCost routes
 */
export interface PackingCostHooks {
  /**
...
/**
 * Default PackingCost hooks (customize as needed)
 */
export const packingCostHooks: PackingCostHooks = {
