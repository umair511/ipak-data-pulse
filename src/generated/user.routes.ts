...
const WRITABLE_SCALAR_FIELDS = ["username", "email", "name", "role", "password", "plainPassword", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["auditLogs", "permissions", "plants"] as const
